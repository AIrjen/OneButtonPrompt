...
from model_lists import get_upscalers_for_img2img
...
def call_img2img(
    ...
    outputimg2imgFull = f'{outputimg2imgfolder}{filename}{outputimg2imgpng}'
    ...
    if prompt == "":
        ...
        png_payload = {"image": encodedstring2}
    ...
    if img2imgupscaler != "automatic":
        ...
        elif "anime" in checkprompt or "cartoon" in checkprompt or "draw" in checkprompt or "vector" in checkprompt \
                or "cel shad" in checkprompt or "visual novel" in checkprompt:
    ...
    if controlnetblockymode is True:
    ...
    if controlnetenabled is True and controlnetmodel != "":
        payload.update({
            "alwayson_scripts": {
                "controlnet": {
                    "args": [{
