...
def build_dynamic_prompt(
    ...
    fictionallist = csv_to_list(
        csvfilename="fictional characters",
        antilist=antilist,
        skipheader=True,
        gender=gender,
    )
    nonfictionallist = csv_to_list(
        csvfilename="nonfictional characters",
        antilist=antilist,
        skipheader=True,
        gender=gender,
    )
    oppositefictionallist = csv_to_list(
        csvfilename="fictional characters",
        antilist=antilist,
        skipheader=True,
        gender=oppositegender,
    )
    oppositenonfictionallist = csv_to_list(
        csvfilename="nonfictional characters",
        antilist=antilist,
        skipheader=True,
        gender=oppositegender,
    ...
    accessorielist = csv_to_list(
        "accessories", antilist, "./csvfiles/", 0, "?", False, False, gender
    )
    artmovementlist = csv_to_list("artmovements", antilist)
    bodytypelist = csv_to_list(
        "body_types", antilist=antilist, skipheader=True, gender=gender
    )
    ...
    directionlist = csv_to_list(
        csvfilename="directions", antilist=antilist, insanitylevel=insanitylevel
    )
    emojilist = csv_to_list("emojis", antilist)
    eventlist = csv_to_list("events", antilist)
    focuslist = csv_to_list(
        csvfilename="focus", antilist=antilist, insanitylevel=insanitylevel
    )
    ...
    hairvomitlist = csv_to_list(
        "hairvomit", antilist, "./csvfiles/", 0, "?", False, False
    )
    humanactivitylist = csv_to_list(
        "human_activities", antilist, "./csvfiles/", 0, "?", False, False
    )
    humanoidlist = csv_to_list("humanoids", antilist)
    imagetypelist = csv_to_list(
        csvfilename="imagetypes", antilist=antilist, insanitylevel=insanitylevel
    )
    joblist = csv_to_list(
        csvfilename="jobs", antilist=antilist, skipheader=True, gender=gender
    )
    lenslist = csv_to_list(
        csvfilename="lenses", antilist=antilist, insanitylevel=insanitylevel
    )
    lightinglist = csv_to_list(
        csvfilename="lighting", antilist=antilist, insanitylevel=insanitylevel
    )
    malefemalelist = csv_to_list(
        csvfilename="malefemale", antilist=antilist, skipheader=True, gender=gender
    )
    manwomanlist = csv_to_list(
        csvfilename="manwoman", antilist=antilist, skipheader=True, gender=gender
    )
    moodlist = csv_to_list(
        csvfilename="moods", antilist=antilist, insanitylevel=insanitylevel
    )
    othertypelist = csv_to_list("othertypes", antilist)
    poselist = csv_to_list("poses", antilist)
    qualitylist = csv_to_list("quality", antilist)
    shotsizelist = csv_to_list(
        csvfilename="shotsizes", antilist=antilist, insanitylevel=insanitylevel
    )
    timeperiodlist = csv_to_list("timeperiods", antilist)
    vomitlist = csv_to_list(
        csvfilename="vomit", antilist=antilist, insanitylevel=insanitylevel
    )
    foodlist = csv_to_list("foods", antilist)
    genderdescriptionlist = csv_to_list(
        csvfilename="genderdescription",
        antilist=antilist,
        skipheader=True,
        gender=gender,
    )
    minilocationlist = csv_to_list("minilocations", antilist)
    minioutfitlist = csv_to_list(
        "minioutfits", antilist, "./csvfiles/", 0, "?", False, False, gender
    )
    ...
    manwomanrelationlist = csv_to_list(
        csvfilename="manwomanrelations",
        antilist=antilist,
        skipheader=True,
        gender=gender,
    )
    manwomanmultiplelist = csv_to_list(
        csvfilename="manwomanmultiples",
        antilist=antilist,
        skipheader=True,
        gender=gender,
        delimiter="?",
    ...
    firstnamelist = csv_to_list(
        csvfilename="firstnames", antilist=antilist, skipheader=True, gender=gender
    )
    ...
    outfitvomitlist = csv_to_list(
        csvfilename="outfitvomit", antilist=antilist, delimiter="?"
    )
    humanexpressionlist = csv_to_list(
        csvfilename="humanexpressions", antilist=antilist, delimiter="?"
    )
    ...
    episodetitlelist = csv_to_list(
        csvfilename="episodetitles", antilist=antilist, skipheader=True
    )
    ...
    if (
        ...
        artists.startswith("personal_artists") == True
        or artists.startswith("personal artists") == True
    ):
    ...
    romanticismartistlist = artist_category_csv_to_list(
        "artists_and_category", "romanticism"
    )
    photographyartistlist = artist_category_csv_to_list(
        "artists_and_category", "photography"
    )
    portraitartistlist = artist_category_csv_to_list("artists_and_category", "portrait")
    characterartistlist = artist_category_csv_to_list(
        "artists_and_category", "character"
    )
    landscapeartistlist = artist_category_csv_to_list(
        "artists_and_category", "landscape"
    )
    scifiartistlist = artist_category_csv_to_list("artists_and_category", "sci-fi")
    graphicdesignartistlist = artist_category_csv_to_list(
        "artists_and_category", "graphic design"
    )
    digitalartistlist = artist_category_csv_to_list("artists_and_category", "digital")
    architectartistlist = artist_category_csv_to_list(
        "artists_and_category", "architecture"
    )
    ...
    # special lists
    backgroundtypelist = csv_to_list(
        "backgroundtypes", antilist, "./csvfiles/special_lists/", 0, "?"
    )
    insideshotlist = csv_to_list(
        "insideshots", antilist, "./csvfiles/special_lists/", 0, "?"
    )
    photoadditionlist = csv_to_list(
        "photoadditions", antilist, "./csvfiles/special_lists/", 0, "?"
    )
    buildhairlist = csv_to_list(
        "buildhair", antilist, "./csvfiles/special_lists/", 0, "?"
    )
    buildoutfitlist = csv_to_list(
        "buildoutfit", antilist, "./csvfiles/special_lists/", 0, "?"
    )
    objectadditionslist = csv_to_list(
        "objectadditions", antilist, "./csvfiles/special_lists/", 0, "?"
    )
    humanadditionlist = csv_to_list(
        "humanadditions", antilist, "./csvfiles/special_lists/", 0, "?"
    )
    animaladditionlist = csv_to_list(
        "animaladditions", antilist, "./csvfiles/special_lists/", 0, "?"
    )
    buildaccessorielist = csv_to_list(
        "buildaccessorie", antilist, "./csvfiles/special_lists/", 0, "?"
    )
    minilocationadditionslist = csv_to_list(
        "minilocationadditions", antilist, "./csvfiles/special_lists/", 0, "?"
    )
    overalladditionlist = csv_to_list(
        "overalladditions", antilist, "./csvfiles/special_lists/", 0, "?"
    )
    imagetypemodelist = csv_to_list(
        "imagetypemodes", antilist, "./csvfiles/special_lists/", 0, "?"
    )
    miniactivitylist = csv_to_list(
        "miniactivity", antilist, "./csvfiles/special_lists/", 0, "?"
    )
    animalsuffixadditionlist = csv_to_list(
        "animalsuffixadditions", antilist, "./csvfiles/special_lists/", 0, "?"
    )
    buildfacepartlist = csv_to_list(
        "buildfaceparts", antilist, "./csvfiles/special_lists/", 0, "?"
    )
    buildfacelist = csv_to_list(
        "buildface", antilist, "./csvfiles/special_lists/", 0, "?"
    )
    ...
    generatenonfictionalcharacter = (
        bool(nonfictionallist) and generatenonfictionalcharacter
    )
    ...
    generateconcepts = (
        bool(conceptprefixlist) and bool(conceptsuffixlist) and generateconcepts
    )
    ...
    if (
        random.randint(1, int(imagemodechance)) == 1
        and imagetype == "all"
        and giventypeofimage == ""
        and onlyartists == False
    ):
        imagetype = random.choice(
            imagetypemodelist
        )  # override imagetype with a random "mode" value
    ...
    if givensubject != "" and smartsubject == True:
        ...
        # outfit
        foundinlist = any(
            word.lower() in [item.lower() for item in outfitlist]
            for word in givensubjectlist
        )
        keywordslist = ["wearing", "outfit", "dressed"]
        keywordsinstring = any(
            word.lower() in givensubject.lower() for word in keywordslist
        )
        ...
        # bodytype
        foundinlist = any(
            word.lower() in [item.lower() for item in bodytypelist]
            for word in givensubjectlist
        )
        ...
        # hair
        foundinlist = any(
            word.lower() in [item.lower() for item in hairstylelist]
            for word in givensubjectlist
        )
        keywordslist = ["hair"]
        keywordsinstring = any(
        ...
        # descriptorlist
        foundinlist = any(
            word.lower() in [item.lower() for item in descriptorlist]
            for word in givensubjectlist
        )
        foundinlist2 = any(
            word.lower() in [item.lower() for item in culturelist]
            for word in givensubjectlist
        )
        ...
        # background
        foundinlist = any(
            word.lower() in [item.lower() for item in locationlist]
            for word in givensubjectlist
        )
        foundinlist2 = any(
            word.lower() in [item.lower() for item in buildinglist]
            for word in givensubjectlist
        )
        ...
        # accessorielist
        foundinlist = any(
            word.lower() in [item.lower() for item in accessorielist]
            for word in givensubjectlist
        )
        if foundinlist == True:
        ...
        # lenslist
        foundinlist = any(
            word.lower() in [item.lower() for item in lenslist]
            for word in givensubjectlist
        )
        if foundinlist == True:
            generatelens = False
        ...
        # lightinglist
        foundinlist = any(
            word.lower() in [item.lower() for item in lightinglist]
            for word in givensubjectlist
        )
        ...
        # mood
        foundinlist = any(
            word.lower() in [item.lower() for item in moodlist]
            for word in givensubjectlist
        )
        keywordslist = ["mood"]
        keywordsinstring = any(
        ...
        # poselist
        foundinlist = any(
            word.lower() in [item.lower() for item in poselist]
            for word in givensubjectlist
        )
        ...
        # qualitylist
        foundinlist = any(
            word.lower() in [item.lower() for item in qualitylist]
            for word in givensubjectlist
        )
        ...
        # shotsize
        foundinlist = any(
            word.lower() in [item.lower() for item in shotsizelist]
            for word in givensubjectlist
        )
        keywordslist = ["shot"]
        keywordsinstring = any(
        ...
        # timeperiodlist
        foundinlist = any(
            word.lower() in [item.lower() for item in timeperiodlist]
            for word in givensubjectlist
        )
        if foundinlist == True:
        ...
        # vomit
        foundinlist = any(
            word.lower() in [item.lower() for item in vomitlist]
            for word in givensubjectlist
        )
        if foundinlist == True:
            generatevomit = False
        ...
        # directionlist
        foundinlist = any(
            word.lower() in [item.lower() for item in directionlist]
            for word in givensubjectlist
        )
        if foundinlist == True:
        ...
        # focus
        foundinlist = any(
            word.lower() in [item.lower() for item in focuslist]
            for word in givensubjectlist
        )
        if foundinlist == True:
            generatefocus = False
        ...
        # artmovementlist
        foundinlist = any(
            word.lower() in [item.lower() for item in artmovementlist]
            for word in givensubjectlist
        )
        if foundinlist == True:
        ...
        # camera
        foundinlist = any(
            word.lower() in [item.lower() for item in cameralist]
            for word in givensubjectlist
        )
        if foundinlist == True:
        ...
        # colorschemelist
        foundinlist = any(
            word.lower() in [item.lower() for item in colorschemelist]
            for word in givensubjectlist
        )
        if foundinlist == True:
    ...
    while compoundcounter < promptstocompound:
        ...
        if templatemode == True:
            templatelist = csv_to_list(
                "templates", antilist, "./csvfiles/templates/", 1, ";", True
            )
            ...
            templateprompts = [
                templateprompt[0]
                for templateprompt in templatelist
                if (
                    (
                        templateprompt[1] == targettemplateenvironment
                        or targettemplateenvironment == "all"
                    )
                    and (
                        templateprompt[2] == templateenvironmentsources
                        or templateenvironmentsources == "all"
                    )
                    and (templateprompt[3] == forcesubject or forcesubject == "all")
                )
            ]
            templatepromptcreator = [
                templateprompt[1]
                for templateprompt in templatelist
                if (
                    (
            ...
            print(
                "Processing a prompt that was inspired from: "
                + templatepromptcreator[templateindex]
            )

            # if there is a subject override, then replace the subject with that
            if givensubject == "":
                completeprompt += chosentemplate.replace(
                    "-subject-", templatesubjects[templateindex]
                )
            else:
        ...
        for i in range(custominputprefixrepeats):
            if (
                chance_roll(insanitylevel, custominputprefixchance)
                and generatecustominputprefix == True
            ):
                completeprompt += random.choice(custominputprefixlist) + ", "

        if insanitylevel == 0:
            insanitylevel = random.randint(
                1, 10
            )  # 10 = add everything, 1 is add almost nothing
        ...
        if (
            artiststyleselector in artiststylelistforchecking
            ...
            if (
                random.randint(0, 6) > max(2, insanitylevel - 2)
                and "concept" in mainchooserlist
            ):
                mainchooserlist.remove("concept")
            if (
                random.randint(0, 6) > max(2, insanitylevel - 2)
                and "landscape" in mainchooserlist
            ):
                mainchooserlist.remove("landscape")
            if (
                random.randint(0, 6) > max(2, insanitylevel - 2)
                and "object" in mainchooserlist
            ):
                mainchooserlist.remove("object")
            if (
                random.randint(0, 6) > max(2, insanitylevel - 2)
                and "animal" in mainchooserlist
            ):
        ...
        if (
            ...
            if (
                ...
                mainchooserlist.remove("object")
            if (
                random.randint(0, 8) > max(2, insanitylevel - 2)
                and "humanoid" in mainchooserlist
            ):
        ...
        if mainchooser == "humanoid":
            ...
            humanoidsubjectchooserlistbackup = (
                humanoidsubjectchooserlist.copy()
            )  # make a backup of the list
            if (
                random.randint(0, 9) > max(2, insanitylevel - 2)
                and "manwomanrelation" in humanoidsubjectchooserlist
            ):
                humanoidsubjectchooserlist.remove("manwomanrelation")
            if (
                random.randint(0, 5) > max(2, insanitylevel - 2)
                and "manwomanmultiple" in humanoidsubjectchooserlist
            ):
                humanoidsubjectchooserlist.remove("manwomanmultiple")
            if (
                random.randint(0, 7) > max(2, insanitylevel - 2)
                and "firstname" in humanoidsubjectchooserlist
            ):
                humanoidsubjectchooserlist.remove("firstname")
            if (
                random.randint(0, 5) > max(2, insanitylevel - 2)
                and "job" in humanoidsubjectchooserlist
            ):
                humanoidsubjectchooserlist.remove("job")
            if (
                random.randint(0, 5) > max(2, insanitylevel - 2)
                and "fictional" in humanoidsubjectchooserlist
            ):
                humanoidsubjectchooserlist.remove("fictional")
            if (
                random.randint(0, 5) > max(2, insanitylevel - 2)
                and "non fictional" in humanoidsubjectchooserlist
            ):
                humanoidsubjectchooserlist.remove("non fictional")
            if (
                random.randint(0, 5) > max(2, insanitylevel - 2)
                and "humanoid" in humanoidsubjectchooserlist
            ):
                humanoidsubjectchooserlist.remove("humanoid")
            # more random stuff on higher levels
            if (
                random.randint(0, 4) > max(2, insanitylevel - 2)
                and "human" in humanoidsubjectchooserlist
            ):
        ...
        if (
            subjectchooser in ["manwomanmultiple"]
            and givensubject != ""
            and subtypehumanoid != "multiple humans"
        ):
            heshelist = ["they"]
            hisherlist = ["their"]
            himherlist = ["them"]
        ...
        if artists != "none" and artistsplacement == "front" and generateartist == True:
            ...
            # in case we have ALL, we can also do a specific artist mode per chosen subject. sometimes
                ...
                if mainchooser in ["humanoid", "animal"]:
                    artistbylist = ["art by", "designed by", "stylized by", "by"]
                    completeprompt += (
                        random.choice(artistbylist)
                        + " OR(-portraitartist-;-characterartist-), OR(-portraitartist-;-characterartist-) OR(;and OR(-fantasyartist-;-scifiartist-;-photographyartist-;-digitalartist-;-graphicdesignartist-);uncommon), "
                    )
                    doartistnormal = False
                    ...
                    completeprompt += (
                        random.choice(artistbylist)
                        + " OR(-landscapeartist-;-digitalartist-), OR(-landscapeartist-;-graphicdesignartist-) OR(;and OR(-fantasyartist-;-scifiartist-;-photographyartist-;-digitalartist-;-graphicdesignartist-);uncommon), "
                    )
                    doartistnormal = False
                    ...
                    completeprompt += (
                        random.choice(artistbylist)
                        + " OR(-landscapeartist-;-architectartist-), OR(-landscapeartist-;-architectartist-) OR(;and OR(-fantasyartist-;-scifiartist-;-photographyartist-;-digitalartist-;-graphicdesignartist-);uncommon), "
                    )
                    doartistnormal = False
                ...
                # else sometimes to something like this?
                    ...
                    completeprompt += (
                        random.choice(artistbylist)
                        + " OR(-portraitartist-;-characterartist-;-fantasyartist-;-scifiartist-;-photographyartist-;-digitalartist-;-graphicdesignartist-), OR(-portraitartist-;-characterartist-;-fantasyartist-;-scifiartist-;-photographyartist-;-digitalartist-;-graphicdesignartist-) and OR(-portraitartist-;-characterartist-;-fantasyartist-;-scifiartist-;-photographyartist-;-digitalartist-;-graphicdesignartist-)"
                    )
                    doartistnormal = False
            ...
            if doartistnormal:
                ...
                while step < end:
                    ...
                    if artistmode not in ["hybrid", "switching"] and not end - step > 1:
                        ...
                        artistmode not in ["hybrid", "switching"]
                        and not end - step == 1
                    ):
                        completeprompt += " and "
            ...
            if onlyartists == True:
                ...
                completeprompt = replacewildcard(
                    completeprompt, insanitylevel, "-artist-", artistlist, False, False
                )
                completeprompt = replacewildcard(
                    completeprompt,
                    insanitylevel,
                ...
                # clean it up
                completeprompt = cleanup(
                    completeprompt, advancedprompting, insanitylevel
                )
        ...
        if giventypeofimage == "" and generatetype == True:
            if (
                imagetype != "all"
                and imagetype != "all - force multiple"
                and imagetype != "only other types"
            ):
                completeprompt += " " + imagetype + ", "
            ...
            if (
                imagetype == "all"
                and chance_roll(insanitylevel, imagetypechance)
                and amountofimagetypes <= 1
            ):
            ...
            for i in range(amountofimagetypes):
                ...
                if (
                    chance_roll(insanitylevel, imagetypequalitychance)
                    or originalartistchoice == "greg mode"
                ) and generateimagetypequality:
                    completeprompt += "-imagetypequality- "
        ...
        if (
            chance_roll(insanitylevel, minilocationadditionchance)
            and generateminilocationaddition == True
        ):
            completeprompt += " -minilocationaddition-, "

        if (
            chance_roll(insanitylevel, artmovementprefixchance)
            and generateartmovement == True
        ):
            generateartmovement = False
            completeprompt += " -artmovement-, "

        if (
            chance_roll(insanitylevel, minivomitprefix1chance)
            and generateminivomit == True
        ):
            completeprompt += " -minivomit-, "

        if (
            chance_roll(insanitylevel, minivomitprefix2chance)
            and generateminivomit == True
        ):
            completeprompt += " -minivomit-, "
        ...
        if (
            mainchooser in ["object", "animal", "humanoid", "concept"]
            and othertype == 0
            and "portrait" not in completeprompt
            and generateshot == True
            and chance_roll(insanitylevel, shotsizechance)
        ):
        ...
        if generatesubject == True:
            ...
            if novel_dist(insanitylevel) and subjectchooser in [
                "animal",
                "animal as human,",
                "human",
                "job",
            ...
            if descriptorsintheback < 2:
                ...
                if (
                    chance_roll(insanitylevel, subjectdescriptor1chance)
                    and generatedescriptors == True
                ):
                    if subjectchooser in [
                        "animal as human,",
                        "human",
                        "job",
                        "fictional",
                ...
                if (
                    chance_roll(insanitylevel, subjectdescriptor2chance)
                    and generatedescriptors == True
                ):
                    if subjectchooser in [
                        "animal as human,",
            ...
            if subjectchooser in [
                ...
                "manwomanmultiple",
                "firstname",
            ] and extraordinary_dist(insanitylevel):
            ...
            if (
                ...
                and chance_roll(insanitylevel, subjectbodytypechance)
                and generatebodytype == True
            ):
            ...
            if (
                ...
                and chance_roll(insanitylevel, subjectculturechance)
                and generatedescriptors == True
            ):
            ...
            if mainchooser == "object":
                ...
                if givensubject == "":
                    ...
                    if hybridorswap == "hybrid":
                        if uncommon_dist(insanitylevel):
                            completeprompt += (
                                "|" + random.choice(objectwildcardlist) + "] "
                            )
                        else:
                            completeprompt += "|"
                            completeprompt += chosenobjectwildcard + " "
            ...
            if (
                ...
                and chance_roll(insanitylevel, joboractivitychance)
                and humanspecial != 1
                and generatesubject == True
            ):
                genjoboractivity = True
                genjoboractivitylocationslist = [
                    "front",
                    "middle",
                    "middle",
                    "back",
            ...
            if mainchooser == "humanoid":
                ...
                if givensubject == "":
                    ...
                    if subjectchooser == "fictional":
                        if (
                            rare_dist(insanitylevel)
                            and advancedprompting == True
                            and buildingfullmode == False
                        ):
                            hybridorswaplist = ["hybrid", "swap"]
                            hybridorswap = random.choice(hybridorswaplist)
                            completeprompt += "["
                    ...
                    if subjectchooser == "non fictional":
                        ...
                        if novel_dist(insanitylevel):
                            completeprompt += (
                                gender + " version of -oppositenonfictional-"
                            )
                        else:
                    ...
                    if (
                        subjectchooser == "manwomanmultiple"
                        and subtypehumanoid != "multiple humans"
                        and givensubject not in ["1girl", "1boy", "solo"]
                    ):
                        if random.randint(0, 1) == 1:
                            completeprompt += (
                                " " + givensubject + " and a -manwomanmultiple- "
                            )
                        else:
                            completeprompt += (
                                " a OR(group;couple;crowd;bunch) of "
                                + givensubject
                                + " "
                            )
                    else:
            ...
            if (
                mainchooser == "humanoid"
                or mainchooser == "animal"
                or mainchooser == "object"
            ) and chance_roll(insanitylevel, subjectconceptsuffixchance):
            ...
            if subjectchooser == "landscape":
                ...
                if givensubject == "":
                    ...
                    if hybridorswap == "swap":
                        completeprompt += (
                            ":" + "-location-" + ":" + str(random.randint(1, 5)) + "] "
                        )
                else:
                    completeprompt += " " + givensubject + " "
                ...
                if (
                    chance_roll(insanitylevel, subjectlandscapeaddonlocationchance)
                    and insideshot == 0
                ):
                    insideshot = 1
                    ...
                    if mainchooser == "humanoid" and legendary_dist(insanitylevel):
                        ...
                        completeprompt += (
                            " in the distance there is a -addontolocationinside- "
                        )
                    else:
                ...
                if (
                    ...
                    completeprompt += " and "
                    if chance_roll(
                        insanitylevel, subjectlandscapeaddonlocationdescriptorchance
                    ):
                        completeprompt += "-locationdescriptor- "
                    if chance_roll(
                        insanitylevel, subjectlandscapeaddonlocationculturechance
                    ):
                        completeprompt += "-culture- "
            ...
            if mainchooser == "concept":
                ...
                # making subject override work with X and Y concepts, much fun!
                    ...
                    if random.randint(0, 3) == 0:
                        completeprompt += (
                            ' " The -conceptprefix- of ' + givensubject + ' " '
                        )
                    else:
                        completeprompt += (
                            ' " The ' + givensubject + ' of -conceptsuffix- " '
                        )
                else:
                    completeprompt += " " + givensubject + " "
            ...
            if descriptorsintheback == 2:
                ...
                if (
                    ...
                    if subjectchooser in [
                        ...
                        completeprompt += (
                            ", OR(;-heshe- is;normal) OR(;very;rare) -descriptor- "
                        )
        ...
        for i in range(objectadditionsrepeats):
            if (
                mainchooser == "object"
                and chance_roll(insanitylevel, objectadditionschance)
                and generateobjectaddition == True
            ):
        ...
        if (
            ...
            and chance_roll(insanitylevel, humanadditionchance)
            and generatehumanaddition == True
        ):
            humanspecial = 1
        ...
        if (
            chance_roll(insanitylevel, overalladditionchance)
            and generateoveralladdition == True
        ):
        ...
        if (
            ...
            and chance_roll(insanitylevel, emojichance)
            and generateemoji == True
        ):
        ...
        if (
            ...
            and chance_roll(insanitylevel, humanexpressionchance)
            and generatehumanexpression == True
        ):
        ...
        if genjoboractivity and genjoboractivitylocation == "back":
            joboractivitylist = [joblist, humanactivitylist]
            completeprompt += (
                ", " + random.choice(random.choice(joboractivitylist)) + ", "
            )
        ...
        if (
            subjectchooser in ["human", "humanoid", "manwomanrelation", "firstname"]
            and chance_roll(insanitylevel, buildfacechance)
            and generateface == True
        ):
        ...
        for i in range(custominputmidrepeats):
            if (
                chance_roll(insanitylevel, custominputmidchance)
                and generatecustominputmid == True
            ):
        ...
        if (
            ...
            and chance_roll(insanitylevel, outfitchance)
            and generateoutfit == True
            and humanspecial != 1
        ):
        ...
        if (
            ...
            and chance_roll(insanitylevel, posechance)
            and humanspecial != 1
            and generatepose == True
        ):
        ...
        if (
            ...
            and chance_roll(insanitylevel, hairchance)
            and generatehairstyle == True
        ):
        ...
        if (
            ...
            and chance_roll(insanitylevel, accessorychance)
            and generateaccessorie == True
            and generateaccessories == True
        ):
            completeprompt += random.choice(buildaccessorielist) + ", "

        if (
            chance_roll(insanitylevel, humanoidinsideshotchance)
            and subjectchooser not in ["landscape", "concept"]
            and generateinsideshot == True
        ):
            insideshot = 1
            completeprompt += random.choice(insideshotlist) + ", "

        if (
            subjectchooser not in ["landscape", "concept"]
            and humanspecial != 1
            and insideshot == 0
            and chance_roll(insanitylevel, humanoidbackgroundchance)
            and generatebackground == True
        ):
            completeprompt += random.choice(backgroundtypelist) + ", "

        # minilocation bit
        if (
            subjectchooser in ["landscape"]
            and chance_roll(insanitylevel, landscapeminilocationchance)
            and generateminilocationaddition == True
        ):
            completeprompt += " -minilocationaddition-, "

        if (
            chance_roll(insanitylevel, generalminilocationchance)
            and generateminilocationaddition == True
        ):
            completeprompt += " -minilocationaddition-, "
        ...
        if (
            mainchooser not in ["landscape"]
            and chance_roll(insanitylevel, focuschance)
            and generatefocus == True
        ):
        ...
        if (
            artists != "none"
            and artistsplacement == "middle"
            and generateartist == True
        ):
            completeprompt += ", "
            doartistnormal = True
            if artists == "greg mode":
        ...
        # others
        if (
            chance_roll(max(1, insanitylevel - 1), directionchance)
            and generatedirection == True
        ):
        ...
        # add in some more mini vomits
        if (
            chance_roll(insanitylevel, minivomitsuffixchance)
            and generateminivomit == True
        ):
            completeprompt += " -minivomit-, "

        if (
            chance_roll(insanitylevel, artmovementchance)
            and generateartmovement == True
        ):
            completeprompt += "-artmovement-, "
        ...
        if (
            chance_roll(insanitylevel, photoadditionchance)
            and isphoto == 1
            and generatephotoaddition == True
        ):
        ...
        if (
            chance_roll(insanitylevel, colorschemechance)
            and generatecolorscheme == True
        ):
            completeprompt += "-colorscheme-, "
        ...
        if (
            mainchooser == "humanoid"
            and chance_roll(insanitylevel, humanvomitchance)
            and generatehumanvomit == True
        ):
        ...
        if (
            chance_roll(insanitylevel, quality1chance)
            or originalartistchoice == "greg mode"
        ) and generatequality == True:
            completeprompt += "-quality-, "
            if (
                chance_roll(insanitylevel, quality2chance)
                or originalartistchoice == "greg mode"
            ):
                completeprompt += "-quality-, "
        ...
        for i in range(custominputsuffixrepeats):
            if (
                chance_roll(insanitylevel, custominputsuffixchance)
                and generatecustominputsuffix == True
            ):
    ...
    if (
        mainchooser == "humanoid"
        and givensubject == ""
        and subjectchooser != "manwomanmultiple"
    ):
        samehumanreplacementlist = [
            "-heshe-",
            "-heshe-",
            "-heshe-",
            "-heshe-",
    ...
    if unique_dist(
        insanitylevel
    ):  # sometimes, its just nice to have descriptor and a normal "outfit". We use mini outfits for this!
    ...
    if random.randint(0, insanitylevel) == 0 and insanitylevel < 5:
        completeprompt = completeprompt.replace(
            "-locationdescriptor-", "-basicbitchdescriptor-"
        )
        completeprompt = completeprompt.replace(
            "-humandescriptor-", "-basicbitchdescriptor-"
        )
        completeprompt = completeprompt.replace(
            "-outfitdescriptor-", "-basicbitchdescriptor-"
        )
        completeprompt = completeprompt.replace(
            "-descriptor-", "-basicbitchdescriptor-"
        )
        completeprompt = completeprompt.replace(
            "-animaldescriptor-", "-basicbitchdescriptor-"
        )
    ...
    if random.randint(0, max(0, insanitylevel - 2)) <= 0:
        completeprompt = completeprompt.replace(
            "-color- and -color-", "-colorcombination-"
        )  # any color and color becomes a color combination

        colorreplacementlist = [
            "-color-",
            "-color-",
            "-color-",
            "-colorcombination-",
    ...
    if random.randint(0, max(0, insanitylevel - 4)) <= 0:
        completeprompt = completeprompt.replace(
            "-material- and -material-", "-materialcombination-"
        )  # any color and color becomes a color combination

        materialreplacementlist = [
            "-material-",
            "-material-",
            "-material-",
            "-materialcombination-",
    ...
    while (
        "-color-" in completeprompt
        or "-material-" in completeprompt
        or "-animal-" in completeprompt
        or "-object-" in completeprompt
        or "-fictional-" in completeprompt
        or "-nonfictional-" in completeprompt
        or "-conceptsuffix-" in completeprompt
        or "-building-" in completeprompt
        or "-vehicle-" in completeprompt
        or "-outfit-" in completeprompt
        or "-location-" in completeprompt
        or "-conceptprefix-" in completeprompt
        or "-descriptor-" in completeprompt
        or "-food-" in completeprompt
        or "-haircolor-" in completeprompt
        or "-hairstyle-" in completeprompt
        or "-job-" in completeprompt
        or "-culture-" in completeprompt
        or "-accessory-" in completeprompt
        or "-humanoid-" in completeprompt
        or "-manwoman-" in completeprompt
        or "-human-" in completeprompt
        or "-colorscheme-" in completeprompt
        or "-mood-" in completeprompt
        or "-genderdescription-" in completeprompt
        or "-artmovement-" in completeprompt
        or "-malefemale-" in completeprompt
        or "-objecttotal-" in completeprompt
        or "-outfitprinttotal-" in completeprompt
        or "-bodytype-" in completeprompt
        or "-minilocation-" in completeprompt
        or "-minilocationaddition-" in completeprompt
        or "-pose-" in completeprompt
        or "-season-" in completeprompt
        or "-minioutfit-" in completeprompt
        or "-elaborateoutfit-" in completeprompt
        or "-minivomit-" in completeprompt
        or "-vomit-" in completeprompt
        or "-rpgclass-" in completeprompt
        or "-subjectfromfile-" in completeprompt
        or "-outfitfromfile-" in completeprompt
        or "-brand-" in completeprompt
        or "-space-" in completeprompt
        or "-artist-" in completeprompt
        or "-imagetype-" in completeprompt
        or "-othertype-" in completeprompt
        or "-quality-" in completeprompt
        or "-lighting-" in completeprompt
        or "-camera-" in completeprompt
        or "-lens-" in completeprompt
        or "-imagetypequality-" in completeprompt
        or "-poemline-" in completeprompt
        or "-songline-" in completeprompt
        or "-greatwork-" in completeprompt
        or "-fantasyartist-" in completeprompt
        or "-popularartist-" in completeprompt
        or "-romanticismartist-" in completeprompt
        or "-photographyartist-" in completeprompt
        or "-emoji-" in completeprompt
        or "-timeperiod-" in completeprompt
        or "-shotsize-" in completeprompt
        or "-musicgenre-" in completeprompt
        or "-animaladdition-" in completeprompt
        or "-addontolocationinside-" in completeprompt
        or "-addontolocation-" in completeprompt
        or "-objectaddition-" in completeprompt
        or "-humanaddition-" in completeprompt
        or "-overalladdition-" in completeprompt
        or "-focus-" in completeprompt
        or "-direction-" in completeprompt
        or "-styletilora-" in completeprompt
        or "-manwomanrelation-" in completeprompt
        or "-manwomanmultiple-" in completeprompt
        or "-waterlocation-" in completeprompt
        or "-container-" in completeprompt
        or "-firstname-" in completeprompt
        or "-flora-" in completeprompt
        or "-print-" in completeprompt
        or "-miniactivity-" in completeprompt
        or "-pattern-" in completeprompt
        or "-animalsuffixaddition-" in completeprompt
        or "-chair-" in completeprompt
        or "-cardname-" in completeprompt
        or "-covering-" in completeprompt
        or "-heshe-" in completeprompt
        or "-hisher-" in completeprompt
        or "-himher-" in completeprompt
        or "-outfitdescriptor-" in completeprompt
        or "-hairdescriptor-" in completeprompt
        or "-hairvomit-" in completeprompt
        or "-humandescriptor-" in completeprompt
        or "-facepart-" in completeprompt
        or "-buildfacepart-" in completeprompt
        or "-outfitvomit-" in completeprompt
        or "-locationdescriptor-" in completeprompt
        or "-basicbitchdescriptor-" in completeprompt
        or "-animaldescriptor-" in completeprompt
        or "-humanexpression-" in completeprompt
        or "-humanvomit-" in completeprompt
        or "-eyecolor-" in completeprompt
        or "-fashiondesigner-" in completeprompt
        or "-colorcombination-" in completeprompt
        or "-materialcombination-" in completeprompt
        or "-oppositefictional-" in completeprompt
        or "-oppositenonfictional-" in completeprompt
        or "-photoaddition-" in completeprompt
        or "-age-" in completeprompt
        or "-agecalculator-" in completeprompt
        or "-gregmode-" in completeprompt
        or "-portraitartist-" in completeprompt
        or "-characterartist-" in completeprompt
        or "-landscapeartist-" in completeprompt
        or "-scifiartist-" in completeprompt
        or "-graphicdesignartist-" in completeprompt
        or "-digitalartist-" in completeprompt
        or "-architectartist-" in completeprompt
        or "-cinemaartist-" in completeprompt
        or "-element-" in completeprompt
        or "-setting-" in completeprompt
        or "-charactertype-" in completeprompt
        or "-objectstohold-" in completeprompt
        or "-episodetitle-" in completeprompt
    ):
        allwildcardslistnohybrid = [
            "-color-",
            "-object-",
            "-animal-",
            "-fictional-",
        ...
        allwildcardslistnohybridlists = [
            ...
            materialcombinationlist,
            oppositefictionallist,
            oppositenonfictionallist,
            photoadditionlist,
            agelist,
            agecalculatorlist,
            gregmodelist,
        ...
        allwildcardslistwithhybridlists = [
            materiallist,
            descriptorlist,
            outfitlist,
            conceptsuffixlist,
        ...
        for wildcard in allwildcardslistnohybrid:
            attachedlist = allwildcardslistnohybridlists[
                allwildcardslistnohybrid.index(wildcard)
            ]
            completeprompt = replacewildcard(
                completeprompt,
                insanitylevel,
        ...
        for wildcard in allwildcardslistwithhybrid:
            attachedlist = allwildcardslistwithhybridlists[
                allwildcardslistwithhybrid.index(wildcard)
            ]
            completeprompt = replacewildcard(
                completeprompt,
                insanitylevel,
...
def replacewildcard(
    ...
    if len(listname) == 0:
        ...
        while wildcard in completeprompt:
            if (
                unique_dist(insanitylevel)
                and activatehybridorswap == True
                and len(listname) > 2
                and advancedprompting == True
            ):
                hybridorswaplist = ["hybrid", "swap"]
                ...
                if hybridorswap == "swap":
                    replacementvalue = random.choice(listname)
                    listname.remove(replacementvalue)
                    hybridorswapreplacementvalue += (
                        ":" + replacementvalue + ":" + str(random.randint(1, 20)) + "] "
                    )

                completeprompt = completeprompt.replace(
                    wildcard, hybridorswapreplacementvalue, 1
                )
            ...
            if wildcard == "-artist-" and "-artiststyle-" in completeprompt:
                ...
                artiststyle = []
                chosenartiststyle = ""
                artiststyles = artist_category_by_category_csv_to_list(
                    "artists_and_category", replacementvalue
                )
                artiststyle = [x.strip() for x in artiststyles[0].split(",")]

                artiststyle = list(
                    filter(lambda x: len(x) > 0, artiststyle)
                )  # remove empty values
                ...
                while bool(artiststyle) and "-artiststyle-" in completeprompt:
                    ...
                    completeprompt = completeprompt.replace(
                        "-artiststyle-", chosenartiststyle, 1
                    )
            ...
            if (
                ...
                if completeprompt.index(wildcard) < completeprompt.index(
                    "-samehumansubject-"
                ):
                    completeprompt = completeprompt.replace(
                        "-samehumansubject-", "the " + replacementvalueforoverrides
                    )
            ...
            if (
                ...
                if completeprompt.index(wildcard) < completeprompt.index(
                    ...
                    completeprompt = completeprompt.replace(
                        "-samehumansubject-", replacementvalueforoverrides
                    )

            # job is here, to prevent issue with a job outfit being replace. So doing it later solves that issue
            if wildcard in ["-job-"] and "-samehumansubject-" in completeprompt:
                if completeprompt.index(wildcard) < completeprompt.index(
                    "-samehumansubject-"
                ):
                    completeprompt = completeprompt.replace(
            ...
            if wildcard in ["-malefemale-"] and "-samehumansubject-" in completeprompt:
                if completeprompt.index(wildcard) < completeprompt.index(
                    "-samehumansubject-"
                ):
                    completeprompt = completeprompt.replace(
            ...
            if (
                ...
                if completeprompt.index(wildcard) < completeprompt.index(
                    ...
                    completeprompt = completeprompt.replace(
                        "-sameothersubject-", "the " + replacementvalueforoverrides
                    )
